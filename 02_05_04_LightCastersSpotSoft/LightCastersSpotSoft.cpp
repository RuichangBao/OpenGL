...
int main()
{
	...
	spotLightShader.setFloat("light.cutOff", glm::cos(glm::radians(12.5f)));	//内圆锥
	//spotLightShader.setFloat("light.outerCutOff", glm::cos(glm::radians(17.5f)));//外圆锥
	spotLightShader.setFloat("light.outerCutOff", glm::cos(glm::radians(15.0f)));//外圆锥
