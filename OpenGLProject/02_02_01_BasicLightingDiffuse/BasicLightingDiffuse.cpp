...
//	Shader lightingShader("shader/LightCubeVertex.shader", "shader/LightCubeFragment.shader");
//	Shader lightCubeShader("shader/DefaultCubeVertex.shader", "shader/DefaultCubeFragment.shader");
